...
def parse_args():
    ...
    parser.add_argument('--image', help='input image', default='test_image.jpg')
...
def main():
    ...
    img_metas = [{'img_shape': det_img.shape, 'ori_shape': image.shape, 'pad_shape': det_img.shape, 'scale_factor': [det_scale for _ in range(4)]}]
    with torch.no_grad():
