...
def parse_args():
    ...
    parser.add_argument('--config', default='configs/yunet_n.py', help='train config file path')
    parser.add_argument('--work-dir', default='training_runs', help='the dir to save logs and models')
