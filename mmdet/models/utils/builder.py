...
def build_transformer(cfg, default_args=None):
    print('Filip YuNet Minify: Function fidx=0 build_transformer called in mmdet/models/utils/builder.py:L9 ')
...
def build_linear_layer(cfg, *args, **kwargs):
    print('Filip YuNet Minify: Function fidx=1 build_linear_layer called in mmdet/models/utils/builder.py:L17 ')
    """Build linear layer.
    Args:
