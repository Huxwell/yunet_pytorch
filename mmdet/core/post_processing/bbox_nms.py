...
def multiclass_nms(multi_bboxes, multi_scores, score_thr, nms_cfg, max_num=
    ...
    print('Filip YuNet Minify: Function fidx=0 multiclass_nms called in mmdet/core/post_processing/bbox_nms.py:L8 ')
    ...
    if score_factors is not None:
        score_factors = score_factors.view(-1, 1).expand(multi_scores.size(
            0), num_classes)
...
def fast_nms(multi_bboxes, multi_scores, multi_coeffs, score_thr, iou_thr,
    top_k, max_num=-1):
    print('Filip YuNet Minify: Function fidx=1 fast_nms called in mmdet/core/post_processing/bbox_nms.py:L98 ')
